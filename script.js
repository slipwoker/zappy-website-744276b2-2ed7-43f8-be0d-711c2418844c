  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          let formErrorEl = contactForm.querySelector('.form-submit-error');
          if (!formErrorEl) {
            formErrorEl = document.createElement('p');
            formErrorEl.className = 'form-submit-error';
            formErrorEl.setAttribute('role', 'alert');
            contactForm.appendChild(formErrorEl);
          }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בננות בפיג'מות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '744276b2-2ed7-43f8-be0d-711c2418844c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '744276b2-2ed7-43f8-be0d-711c2418844c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '744276b2-2ed7-43f8-be0d-711c2418844c';
